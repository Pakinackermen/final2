...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 10, 2019 at 05:06 AM
...
--
-- Table structure for table `changedata`
--

CREATE TABLE `changedata` (
  `id_change` int(12) NOT NULL,
  `new` text NOT NULL COMMENT 'file ที่เพิ่มขึ้น',
  `reduce` text NOT NULL COMMENT 'file ที่หาย',
  `size` text NOT NULL,
  `id_checkdata` int(12) NOT NULL,
  `date` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `changedata`
--

INSERT INTO `changedata` (`id_change`, `new`, `reduce`, `size`, `id_checkdata`, `date`) VALUES
(1, 'path', '', '12323', 20, '2019-02-20 07:31:35');
...
--
-- Indexes for table `changedata`
--
ALTER TABLE `changedata`
...
--
-- AUTO_INCREMENT for table `changedata`
--
ALTER TABLE `changedata`
  MODIFY `id_change` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
