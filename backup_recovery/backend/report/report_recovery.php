...
$sql = "checkdata where status = 'R' AND update_by = '$sessionUsername'";
...
while ($Row = $row->fetch_assoc()) {
    ?>
                       <tr>
                        ...
                        <td><?=$Row["datetime"]?></td>
                        <td>
                          <a href="core.php?Recovery=<?=$Row["id"]?>" >รายละเอียด </a>
                        </td>
                       </tr>
...
<form action="/backup_recovery/core.php?report=recovery&page=report" method="post">
