                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-12 justify-content-center">
                                    ...
                                    <button type="button" onclick="validate();" class="btn btn-primary col-md-6 " name="addnewUser"
                                        value="addnewUser">เพิ่ม</button>
                                    <button type="button" class="btn btn-accent col-md-3" onclick="window.history.back()"
                                        name="edit">กลับ</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    function validate() {
        ...
        if (pass1 == pass2) {
            ...
            alert("กรุณากรอกข้อมูลรหัสผ่านให้ตรงกัน");
        }
